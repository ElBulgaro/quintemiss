...
export function CandidatesView({
  ...
  if (isLoading) {
    return (
      <div className={`container grid ${singleColumn ? 'grid-cols-1' : 'grid-cols-1 md:grid-cols-2'} gap-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8`}>
        {[...Array(8)].map((_, index) => (
  ...
  return (
    <motion.div 
      className={`container grid ${singleColumn ? 'grid-cols-1' : 'grid-cols-1 md:grid-cols-2'} gap-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8`}
